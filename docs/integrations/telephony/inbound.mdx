...
description: "Configure inbound calling for Twilio, Vonage, Plivo, Telnyx, Cloudonix, Exotel, Vobiz, and Asterisk ARI providers in Dograh AI"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Exotel" href="/integrations/telephony/exotel">
    Connect Voice AI inbound with bidirectional media streaming
  </Card>
...
- [Exotel Configuration](/integrations/telephony/exotel#configuration)
...
- [Exotel Inbound Setup](/integrations/telephony/exotel#inbound-calling-setup)
